    ...
    <div id="content"> 
      ...
      <div class="container-fluid"> 
        ...
        <div class="row">
          ...
          $dados = file_get_contents( 'https://pokeapi.co/api/v2/type' );
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="#" onClick="typepokemon('<?=$results->name?>')">
                      <?=$results->name?>
                      </a></div>
                  </div>
...
<!-- Logout Modal-->
<div class="modal fade" id="typepokemon" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="tbodypodemons">
...
function typepokemon(type)
	...
	$.ajax({
				...
				$ ('#tbodypodemons').html(data.resposta);
				$('#typepokemon').modal('show');				
				}
            });
